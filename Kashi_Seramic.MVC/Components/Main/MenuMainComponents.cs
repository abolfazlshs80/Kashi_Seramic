...
{
    public class MenuMainComponents : ViewComponent
    {
        ...
        public MenuMainComponents(IMenuService menuService,
            IMapper mapper,
        ...
        public async Task<IViewComponentResult> InvokeAsync()
        {
            ...
            return View("/Views/Components/Main/MenuMain.cshtml", model);
        }
