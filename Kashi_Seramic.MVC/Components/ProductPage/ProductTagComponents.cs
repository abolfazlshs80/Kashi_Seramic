...
{
    public class ProductTagComponents : ViewComponent
    {
        ...
        public ProductTagComponents(IBlogService BlogService,
            IMapper mapper,
        ...
        public async Task<IViewComponentResult> InvokeAsync()
        {
            ...
            return View("/Views/Components/ProductPage/ProductTag.cshtml", model);
