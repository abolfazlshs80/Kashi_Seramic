...
{
    public class TopProductItemMainPageComponents : ViewComponent
    {
        ...
        public TopProductItemMainPageComponents(ICategoryService catService, IBlogService _blogService, ISettingService _settingService,
        ...
        {
            ViewBag.Title = "قیمت اخررین برای صاحبان خانه";
            ...
            var model = await _ProductService.GetProductsTopByNumber(6);
