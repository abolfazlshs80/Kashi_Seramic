...
namespace Kashi_Seramic.Application.Features.LeaveTypes.Handlers.Queries
{
    ...
    {
        private readonly ITicketRepository _rep_cate;
        private readonly IMapper _mapper;

        public GetTicketListRequestHandler(ITicketRepository rep_cate, IMapper mapper)
        {
            _rep_cate = rep_cate;
            _mapper = mapper;
        }
        ...
        {
            var leaveTypes = await _rep_cate.GetTicketWithDetails();
            return _mapper.Map<List<TicketDto>>(leaveTypes);
        }
    }
}
