...
{
    public class CreateTicketToReplyDtoValidator : AbstractValidator<CreateTicketToReplyDto>
    {
        private readonly ITicketToReplyRepository _rep;

        public CreateTicketToReplyDtoValidator(ITicketToReplyRepository rep)
        {
            _rep = rep;
