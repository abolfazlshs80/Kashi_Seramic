...
{
    public class CreateFilterProductDtoValidator : AbstractValidator<CreateFilterProductDto>
    {
        private readonly IFilterProductRepository _rep;

        public CreateFilterProductDtoValidator(IFilterProductRepository rep)
        {
            _rep = rep;
